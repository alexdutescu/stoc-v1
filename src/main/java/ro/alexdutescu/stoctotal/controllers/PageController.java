...
import ro.alexdutescu.stoctotal.utils.LazyStocDataModel;
...
//    End getters & setters
    @Inject StocTotalFacadeLocal stocService;
...
//        FacesContext.getCurrentInstance().addMessage(null, msg);
    ...
    public void manageApplyButton() {
        ...
        Utilizatori u = (Utilizatori)Faces.getSessionAttribute("utilizator");
        if(u != null && u.getLocatie().toLowerCase().equals("god_mode")) {
        ...
        if(u != null && !u.getLocatie().toLowerCase().equals("god_mode")) {
            lazyStocModel = new LazyStocDataModel(stocService.findStocByFilters(u.getLocatie(), inputCod, inputNume, inputProducator, selectat));
        }
    ...
    private void debugMessage(String mesaj) {
        Logger.getLogger(PageController.class.toString()).log(Level.INFO, mesaj);
    }
}
